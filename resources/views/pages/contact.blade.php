                ...
                <div class="pt-4 border-t border-[#E5E5E5]">
                    ...
                    <div class="flex flex-wrap items-center gap-2.5">
                        @if(!empty($siteSettings['instagram']))
                            <a href="{{ $siteSettings['instagram'] }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-3.5 py-2 border border-[#E5E5E5] bg-white text-xs font-semibold text-[#1F1F1F] hover:border-[#8B1E24] hover:text-[#8B1E24] hover:bg-[#FAF9F6] transition-all">
                        ...
                        @if(!empty($siteSettings['facebook']))
                            <a href="{{ $siteSettings['facebook'] }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-3.5 py-2 border border-[#E5E5E5] bg-white text-xs font-semibold text-[#1F1F1F] hover:border-[#8B1E24] hover:text-[#8B1E24] hover:bg-[#FAF9F6] transition-all">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        @if(!empty($siteSettings['tiktok']))
                            <a href="{{ $siteSettings['tiktok'] }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-3.5 py-2 border border-[#E5E5E5] bg-white text-xs font-semibold text-[#1F1F1F] hover:border-[#8B1E24] hover:text-[#8B1E24] hover:bg-[#FAF9F6] transition-all">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        @if(!empty($siteSettings['youtube']))
                            <a href="{{ $siteSettings['youtube'] }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-3.5 py-2 border border-[#E5E5E5] bg-white text-xs font-semibold text-[#1F1F1F] hover:border-[#8B1E24] hover:text-[#8B1E24] hover:bg-[#FAF9F6] transition-all">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
